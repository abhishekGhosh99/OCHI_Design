...
const Cards = () => {
  return (
    <div className="w-full bg-zinc-100 py-28 font-[NeueMontreal] border-b-[1px] border-zinc-500">
      ...
      <div className="cards w-full flex px-8 flex-wrap overflow-hidden">
        <div className="card-container relative w-1/2 h-[80vh] px-6 pb-20 mb-16">
          <div className="card-text w-full flex text-zinc-800 font-medium">
            <div className="card-text w-1/2 py-6 px-3 flex flex-row items-center justify-start gap-2">
              <div className="w-[10px] h-[10px] rounded-full bg-black"></div>
              <h1>FYDE</h1>
            </div>
          </div>
          <div className="card w-full h-full rounded-2xl overflow-hidden">
            <h1 className="absolute text-[#CCEB68] text-[12vw] font-[FoundersGrotesk] tracking-normal font-extrabold left-full -translate-x-[9vw] top-1/2 -translate-y-[8vw] z-10">
              FYDE
            </h1>
            <img
        ...
        <div className="card-container relative w-1/2 h-[80vh] px-6 pb-20 mb-16">
          ...
          <div className="card w-full h-full rounded-2xl overflow-hidden">
            <h1 className="absolute text-[#CCEB68] text-[12vw] font-[FoundersGrotesk] tracking-normal font-extrabold right-full translate-x-[7vw] top-1/2 -translate-y-[8vw] z-10">
              VISE
            </h1>
            <img
        ...
        <div className="card-container relative w-1/2 h-[80vh] px-6 pb-20 mb-16">
          ...
          <div className="card w-full h-full rounded-2xl overflow-hidden">
            <h1 className="absolute text-[#CCEB68] text-[12vw] font-[FoundersGrotesk] tracking-normal font-extrabold left-full -translate-x-[12.5vw] top-1/2 -translate-y-[8vw] z-10">
              TRAWA
            </h1>
            <img
        ...
        <div className="card-container relative w-1/2 h-[80vh] px-6 pb-20">
          <div className="card-text w-full flex text-zinc-800 font-medium">
            <div className="card-text w-1/2 py-6 px-3  flex flex-row items-center justify-start gap-2">
              <div className="w-[10px] h-[10px] rounded-full bg-black"></div>
              <h1>PREMIUM BLEND</h1>
          ...
          <div className="card w-full h-full rounded-2xl overflow-hidden">
            <h1 className="absolute text-[#CCEB68] text-[12vw] font-[FoundersGrotesk] tracking-normal text-nowrap font-extrabold right-full translate-x-[28vw] top-1/2 -translate-y-[8vw] z-10">
              PREMIUM BLEND
            </h1>
            <img
