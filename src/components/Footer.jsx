        ...
        <div className="right lg:relative w-full lg:w-[50vw] flex flex-col text-zinc-100">
          ...
          <div className="nav-links absolute top-[30%] lg:top-[60%] font-[NeueMontreal] lg:bottom-[12vh] lg:right-[10vw]">
            <ul>
              ...
              <li className="underline underline-offset-[4px]">Services</li>
              <li className="underline underline-offset-[4px]">Our Work</li>
              <li className="underline underline-offset-[4px]">About Us</li>
              <li className="underline underline-offset-[4px]">Insights</li>
              <li className="underline underline-offset-[4px]">Contact Us</li>
            </ul>
          </div>
        </div>
      </div>
